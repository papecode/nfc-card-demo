...
export const mockNfcCards: NfcCard[] = [
  ...
  },
  {
    ...
    name: 'Carte Networking',
    description: 'Ma carte pour le networking professionnel',
    qrCode: 'https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://nfc-card-demo.vercel.app/cards/card-006',
    isActive: true,
 ...
 
  {
    ...
    name: 'Carte Networking',
    description: 'Ma carte pour le networking professionnel',
    qrCode: 'https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://nfc-card-demo.vercel.app/cards/card-007',
    isActive: true,
    createdAt: '2025-05-18T00:00:00Z',
  ...
  },
  {
    ...
    name: 'Carte Networking',
    description: 'Ma carte pour le networking professionnel',
    qrCode: 'https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://nfc-card-demo.vercel.app/cards/card-008',
    isActive: true,
    createdAt: '2025-05-18T00:00:00Z',
    linkedin: '',
  ...
  },
  {
    ...
    name: 'Carte Networking',
    description: 'Ma carte pour le networking professionnel',
    qrCode: 'https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://nfc-card-demo.vercel.app/cards/card-009',
    isActive: true,
    createdAt: '2025-05-18T00:00:00Z',
    linkedin: '',
  ...
  },
  {
    ...
    name: 'Carte Networking',
    description: 'Ma carte pour le networking professionnel',
    qrCode: 'https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://nfc-card-demo.vercel.app/cards/card-010',
    isActive: true,
    createdAt: '2025-05-18T00:00:00Z',
  ...
  },
  {
    ...
    name: 'Carte Networking',
    description: 'Ma carte pour le networking professionnel',
    qrCode: 'https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://nfc-card-demo.vercel.app/cards/card-011',
    isActive: true,
    createdAt: '2025-05-18T00:00:00Z',
  ...
  },
  {
    ...
    name: 'Carte Networking',
    description: 'Ma carte pour le networking professionnel',
    qrCode: 'https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://nfc-card-demo.vercel.app/cards/card-012',
    isActive: true,
    createdAt: '2025-05-18T00:00:00Z',
  ...
  },
  {
    ...
    name: 'Carte Networking',
    description: 'Ma carte pour le networking professionnel',
    qrCode: 'https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://nfc-card-demo.vercel.app/cards/card-013',
    isActive: true,
    createdAt: '2025-05-18T00:00:00Z',
  ...
  },
  {
    ...
    name: 'Carte Networking',
    description: 'Ma carte pour le networking professionnel',
    qrCode: 'https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://nfc-card-demo.vercel.app/cards/card-014',
    isActive: true,
    createdAt: '2025-05-18T00:00:00Z',
  ...
  },
  {
    ...
    name: 'Carte Networking',
    description: 'Ma carte pour le networking professionnel',
    qrCode: 'https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://nfc-card-demo.vercel.app/cards/card-015',
    isActive: true,
    createdAt: '2025-05-18T00:00:00Z',
  ...
  },
  {
    ...
    name: 'Carte Networking',
    description: 'Ma carte pour le networking professionnel',
    qrCode: 'https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://nfc-card-demo.vercel.app/cards/card-016',
    isActive: true,
    createdAt: '2025-05-18T00:00:00Z',
    linkedin: '',
    job: 'Ministre du travail',
